...
test("workflow ai queue preview raises proof and dispute flags with a decision suggestion", () => {
  const advice = service.buildQueuePreview({
    order: {
      ...
      contractId: null,
      onChainOrderId: null,
      sellerWallet: "GSELLERAI100000000000000000000000000000000000000000000",
      buyerWallet: "GBUYERAI1000000000000000000000000000000000000000000000",
      riderWallet: null,
      orderCreatedTxHash: null,
      fundingTxHash: null,
  ...
  try {
    const advice = await service.analyzeProof({
      order: {
        ...
        contractId: null,
        onChainOrderId: null,
        sellerWallet: "GSELLERAI200000000000000000000000000000000000000000000",
        buyerWallet: "GBUYERAI2000000000000000000000000000000000000000000000",
        riderWallet: null,
        orderCreatedTxHash: null,
        fundingTxHash: null,
        fundingStatus: "not_started",
  ...
  try {
    const advice = await service.analyzeProof({
      order: {
        ...
        contractId: null,
        onChainOrderId: null,
        sellerWallet: "GSELLERAI300000000000000000000000000000000000000000000",
        buyerWallet: "GBUYERAI3000000000000000000000000000000000000000000000",
        riderWallet: null,
        orderCreatedTxHash: null,
        fundingTxHash: null,
        fundingStatus: "not_started",
