  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="rounded-full border border-line bg-night/80 px-3 py-2 text-xs font-semibold text-ink/70">
      ...
      {lastHistory?.note ? (
        <div className="surface-card p-4 text-sm text-ink/80">
